...
@property (nonatomic, retain) IBOutlet CameraReader* camScreen;
...
@property (nonatomic, retain) IBOutlet UISegmentedControl* accel;
@property (nonatomic, retain) IBOutlet UISegmentedControl* accelMode;
